                ...
                <Fragment>
                    ...
                    {!scan && !ScanResult &&
                        <View style={styles.cardView} >
                            ...
                            <Image source={require('./assets/qr-code.png')} style={{margin: 20, width:200, height:200}}></Image>
                    ...
                    {scan &&
                        <QRCodeScanner
                            ...
                            bottomContent={
                                <View>
                                    <ImageBackground source={require('./assets/bottom-panel.png')} style={{...styles.bottomContent, width:30, height:30}}>
                                        <TouchableOpacity style={styles.buttonScan2} 
                                            onPress={() => this.scanner.reactivate()} 
                                            onLongPress={() => this.setState({ scan: false })}>
                                            <Image source={require('./assets/camera2.png')} style={{ width:30, height:30 }}></Image>
                                        </TouchableOpacity>
                                    </ImageBackground>
                                </View>
                            }
